...
namespace B21_Ex05.Interface
{
    public partial class ReversedTicTacToeForm : Form
    {
	    ...
	    private void ReversedTicTacToe_Load(object i_Sender, EventArgs i_EventArgs)
        {
            ...
            this.m_OverallLayout.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 1.0f));
           // this.m_OverallLayout.RowStyles.Clear();

            //this.m_OverallLayout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.AutoSize));
            //this.m_OverallLayout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, this.m_Player1.Height));
